 ...
 *  under the License.
 */
package org.estatio.module.docflow;
...
public final class EstatioDocFlowModule extends ModuleAbstract {

    public EstatioDocFlowModule(){}
    ...
    @Override public FixtureScript getRefDataSetupFixture() {
        return new FixtureScript() {
            ...
            protected void execute(final ExecutionContext ec) {
                ec.executeChild(this, new DocumentTypeFSForDocFlow());
            }
        };
    }
