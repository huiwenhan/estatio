package org.estatio.module.communications.dom.impl.comms;
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.estatio.module.communications.dom.impl.comms.Communication "
                        + "WHERE this.correspondents.contains(correspondent) "
                        + "   && correspondent.channel == :communicationChannel  "
                        + " VARIABLES org.estatio.module.communications.dom.impl.comms.CommChannelRole correspondent "),
        @Query(
