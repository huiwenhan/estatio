...
import org.estatio.module.document.dom.impl.renderers.RendererFromBytesToBytesWithPreviewToUrl;
import org.estatio.module.document.dom.impl.renderers.RendererFromBytesToChars;
import org.estatio.module.document.dom.impl.renderers.RendererFromBytesToCharsWithPreviewToUrl;
import org.estatio.module.document.dom.impl.renderers.RendererFromCharsToBytes;
import org.estatio.module.document.dom.impl.renderers.RendererFromCharsToBytesWithPreviewToUrl;
import org.estatio.module.document.dom.impl.renderers.RendererFromCharsToChars;
import org.estatio.module.document.dom.impl.renderers.RendererFromCharsToCharsWithPreviewToUrl;
...
@Queries({
        @javax.jdo.annotations.Query(
                ...
                value = "SELECT "
                        + "FROM org.estatio.module.document.dom.impl.docs.DocumentTemplate "
                        + "WHERE typeCopy   == :type "
                        + "   && atPathCopy == :atPath "
                        + "ORDER BY date DESC"
        ),
