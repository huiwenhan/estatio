 ...
 *  under the License.
 */
package org.estatio.module.docflow.seed;
...
public class DocumentTypeFSForDocFlow extends DocumentTemplateFSAbstract {
    ...
    protected void execute(final ExecutionContext executionContext) {
        upsertType(DocumentTypeData.DOCFLOW_METADATA, executionContext);
        upsertType(DocumentTypeData.DOCFLOW_FATURRA_P7M, executionContext);
        upsertType(DocumentTypeData.DOCFLOW_FATURRA_XML, executionContext);
    }
