...
public abstract class DocumentAbstract<T extends DocumentAbstract> implements Comparable<T>, HasAtPath, HasMimeType {
    ...
    public Clob getClob() {
        ...
        org.estatio.module.document.dom.impl.docs.DocumentSort#asChars(DocumentSort.java:120)
        org.estatio.module.document.dom.impl.docs.DocumentAbstract#asChars(DocumentAbstract.java:255)
        org.estatio.module.document.dom.impl.docs.DocumentAbstract#getClob(DocumentAbstract.java:208)
