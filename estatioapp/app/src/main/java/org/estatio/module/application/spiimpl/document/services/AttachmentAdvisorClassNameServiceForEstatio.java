...
public class AttachmentAdvisorClassNameServiceForEstatio extends ClassNameServiceAbstract<AttachmentAdvisor> implements
        AttachmentAdvisorClassNameService {

    public AttachmentAdvisorClassNameServiceForEstatio() {
        super(AttachmentAdvisor.class, "org.estatio");
    }
