package org.estatio.module.document.integtests.demo.dom.demowithnotes;
...
@javax.jdo.annotations.Queries({
        @javax.jdo.annotations.Query(
                name = "findByName",
                value = "SELECT "
                        + "FROM org.estatio.module.document.integtests.demo.dom.demowithnotes.DemoObjectWithNotes "
...
public class DemoObjectWithNotes implements Comparable<DemoObjectWithNotes> {
